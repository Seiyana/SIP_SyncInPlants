...
const PLANTS_DATABASE = [
    ...
    { name: 'Jade Plant', rarity: 'Common', moisture: 'Low', threshold: { min: 25, max: 40 }, image: 'https://clluovsscjmlhcbvsgcz.supabase.co/storage/v1/object/sign/SIP_Assets/Plants/Jade_Plant.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV84MTA0N2NiNy1lN2IxLTQ5YzUtYjdhMS00YThiZGRlZjEzZDgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJwbGFudC1pbWFnZXMvSmFkZV9QbGFudC5wbmciLCJpYXQiOjE3NjQ1ODkwOTEsImV4cCI6MTc5NjEyNTA5MX0.C0P9l-PtORZ77WPWa_jYsGlxawn2huL2Ik9n1gVNZeg' },
    // Uncommon Plants
    { name: 'Monstera Deliciosa', rarity: 'Uncommon', moisture: 'Medium', threshold: { min: 50, max: 70 }, image: 'https://clluovsscjmlhcbvsgcz.supabase.co/storage/v1/object/sign/SIP_Assets/Plants/Monstera_Deliciosa.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV84MTA0N2NiNy1lN2IxLTQ5YzUtYjdhMS00YThiZGRlZjEzZDgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJwbGFudC1pbWFnZXMvTW9uc3RlcmFfRGVsaWNpb3NhLnBuZyIsImlhdCI6MTc2NDU4OTExNSwiZXhwIjoxNzk2MTI1MTE1fQ._TXC3IP393Bzh3-rRypsv02C-xPNAe8oaYWztFbxqzE' },
    { name: 'Fiddle Leaf Fig', rarity: 'Uncommon', moisture: 'Medium', threshold: { min: 45, max: 65 }, image: 'https://clluovsscjmlhcbvsgcz.supabase.co/storage/v1/object/sign/SIP_Assets/plant-images/Fiddle_Leaf_Fig.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV84MTA0N2NiNy1lN2IxLTQ5YzUtYjdhMS00YThiZGRlZjEzZDgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJwbGFudC1pbWFnZXMvRmlkZGxlX0xlYWZfRmlnLnBuZyIsImlhdCI6MTc2NDU4OTEzNSwiZXhwIjoxNzk2MTI1MTM1fQ.wUKmjUwlJJ3ie0hj8Mw7FSkINK1MhIqvtAJI9QN9h8U' },
